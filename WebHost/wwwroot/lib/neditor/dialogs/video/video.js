...
(function () {
    ...
    */
    function insertSingle() {
        ...
        var insertType = isModifyUploadVideo ? 'upload' : null;
        if (editor.options.html5Video) insertType = 'upload';
    ...
    */
    ...
    function insertUpload() {
        ...
        videoSrcField = '';
        var videoUploadService = editor.getOpt("videoUploadService");
        if (videoUploadService) {
            videoUploadService = videoUploadService(this, editor);
            videoSrcField = videoUploadService.videoSrcField;
        }
        videoSrcField = videoSrcField || 'url';
        ...
        var count = uploadFile.getQueueInfo().count;
        if (count) {
    ...
    UploadVideo.prototype = {
        ...
        initUploader: function () {
            ...
            uploader.on('fileQueued', function (file) {
                ...
                var videoUploadService = editor.getOpt("videoUploadService");
                if (videoUploadService) {
                    videoUploadService = videoUploadService(_this, editor);
                    if (videoUploadService.setUploadData) videoUploadService.setUploadData(file);
                }
            ...
            uploader.on('all', function (type, files) {
                switch (type) {
                    ...
                    case 'startUpload':
                        ...
                        if (videoUploadService) {
                            videoUploadService = videoUploadService(_this, editor);
                            if (videoUploadService.setUploaderOptions) {
            ...
            uploader.on('uploadBeforeSend', function (object, data, headers) {
                ...
                if (videoUploadService) {
                    videoUploadService = videoUploadService(_this, editor);
                    if (videoUploadService.setFormData) videoUploadService.setFormData(object, data, headers);
                }
            ...
            uploader.on('uploadSuccess', function (file, res) {
                ...
                try {
                    ...
                    if (videoUploadService) {
                        videoUploadService = videoUploadService(_this, editor);
                        if (videoUploadService.getResponseSuccess) {
                            if (videoUploadService.getResponseSuccess(res)) {
