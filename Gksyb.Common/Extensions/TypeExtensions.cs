...
namespace Gksyb.Common
{
    ...
    public static class TypeExtensions
    {
        ...
        {
            if (IsNullableType(type) || !type.GetTypeInfo().IsValueType) return type;
        ...
        {
            var typeCode = Type.GetTypeCode(type.GetUnNullableType());
            return (type.IsPrimitive && type.IsValueType && !type.IsEnum && typeCode != TypeCode.Char && typeCode != TypeCode.Boolean) || typeCode == TypeCode.Decimal;
        }
        ...
        public static Dictionary<string, MethodInfo> GetDicMethods(this Type type, BindingFlags? flags = null)
        {
            ...
            var methods = type.GetMethods(flags.Value);
