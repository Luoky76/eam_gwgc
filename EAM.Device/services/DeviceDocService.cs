...
{
    public class DeviceDocService : BaseService, IDeviceDocService
    {
        ...
        public DeviceDocService(IDbContext dbContext, UserSession userSession, IComboxDataService comboxService)
        {
