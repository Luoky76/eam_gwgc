...
{
    public class LaborMaterialService : IBaseService
    {
        ...
        {
            return await _dbContext.UpdateAsync<LABOR_MATERIAL>(
                c => sids.Contains(c.LABOR_MATERIAL_ID),
                c => new LABOR_MATERIAL
                {
                    AUDITING = "1"
                });
        }
