...
namespace Gksyb.Model
{
    ...
    public class SP_OUTAPP_DET
    {
        ...
        [Description("库存ID")]
        [Column(DbType = DbType.AnsiString)]
        public string STORE_ID2 { get; set; }
        ...
        [Description("是否扫码")]
        [Column(DbType = DbType.AnsiString)]
        public string IS_SM { get; set; }

        /// <summary>
        /// 库存数量
        /// </summary>
        [Description("库存数量")]
        public decimal? STORE_NUM2 { get; set; }

        /// <summary>
        /// 总库存数量
        /// </summary>
        [Description("总库存数量")]
        public decimal? SUMSTORE_NUM { get; set; }
